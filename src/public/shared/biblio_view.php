...
<table class="primary">
  ...
  ?>
        <tr>
          ...
          <td valign="top" class="primary">
	    <?php if($key == "856a") { ?>
              <a href="<?php echo H($field->getFieldData()); ?>"><?php echo H($field->getFieldData()); ?></a>
            <?php } elseif(0 === strpos($key, "306a")) { ?>
              <?php if (strlen(H($field->getFieldData())) == 6) {?>
                <?php $split = str_split(H($field->getFieldData()), 2);?>
                <?php echo $split[0] . " hours " . $split[1] . " minutes"; ?>
              <?php } else { ?>
                <pre><?php echo H($field->getFieldData()); ?></pre>
              <?php } ?>
            <?php }else{ ?>
              <pre><?php echo H($field->getFieldData()); ?></pre>
            <?php } ?>
